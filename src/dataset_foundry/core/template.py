...
class Template:
    ...
    def resolve(self, variables: Dict[str, Any], formatters: Dict[str, callable] = None) -> str:
        """
        ...
        Args:
            ...
            formatters (dict): A dictionary of formatters to apply to the variables. If not
                provided, the default formatters will be used: `yaml`, `json`, `upper`, `lower`.
